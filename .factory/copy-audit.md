...
| 6 | Patchboard generates noise in this browser. |
...
| 5 | This browser blocked local saving. |
| 7 | Use Share patch to keep a link. |
| 2 | [Module] selected. |
| 7 | Change a value to hear it immediately. |
| 5 | Speaker is the final output. |
| 8 | Choose a module that can send a signal. |
| 4 | Now choose a destination. |
| 5 | [Module] is the cable source. |
| 3 | Choose a destination. |
| 5 | A module cannot feed itself. |
| 10 | Speaker is the final output and cannot send a cable. |
| 10 | [Module] is a sound source and cannot receive a cable. |
| 4 | That cable already exists. |
| 7 | That cable would create a feedback loop. |
| 2 | Cable added. |
| 6 | Choose another source, or finish editing. |
| 4 | Cable [source] → [destination] connected. |
| 4 | Cable [source] → [destination] removed. |
| 4 | Reconnect it to undo. |
| 6 | The graph has no connected cables. |
| 5 | [Module] updated in variant [A/B]. |
| 8 | Tempo set to [number] BPM in variant [A/B]. |
| 2 | Audio stopped. |
| 5 | Your patch is still here. |
| 5 | Audio running at [number] BPM. |
| 8 | Change one value or switch variants to compare. |
| 4 | Audio could not start. |
| 5 | Check this tab’s sound permission. |
| 4 | Variant [A/B] is live. |
| 5 | [number] cables at [number] BPM. |
| 2 | Sample ready. |
| 11 | Press Start audio, then switch between Hear A and Hear B. |
| 4 | Start a new patch? |
| 8 | This replaces the saved A and B variants. |
| 7 | Shared links you copied will still work. |
| 4 | New default patch ready. |
| 6 | Demo reset to the original sample. |
| 3 | Cable editing on. |
| 7 | Choose a source module, then a destination. |
| 3 | Cable editing finished. |
| 7 | Reduced motion on. Signal movement is static. |
| 9 | Reduced motion off. Live cables move while audio runs. |
| 12 | Variant [A/B] copied to [A/B]. Switch to [A/B], then change one thing. |
| 3 | Share link copied. |
| 4 | Web Audio code copied. |
| 4 | Clipboard access was blocked. |
| 7 | The link is selected for keyboard copying. |
| 7 | The code is selected for keyboard copying. |
| 3 | Cable editing cancelled. |
| 5 | Offline setup did not finish. |

...
The URL opens directly on the “Neon steps” workbench. Its banner, patch name, active A/B state, signal graph, visible connections, and **Start audio** control are in the first phone viewport. Variant B adds Noise → Filter, raises the filter cutoff and resonance, and lengthens the echo. Press **Start audio**, then **Hear A** and **Hear B** to compare it.
